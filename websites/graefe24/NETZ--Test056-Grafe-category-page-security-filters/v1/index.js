(() => {
    ...
    const ASSETS = {
        tooltip_svg: /* HTML */ `
            <svg width="19" height="20" viewBox="0 0 19 20" fill="#13629b" xmlns="http://www.w3.org/2000/svg">
                <path
                        ...
                        <div class="ab-security-layout__options">
                            ${OPTIONS_DATA.map(
                                ({ id, label, mobileOrder, labelFor }) => /* HTML */ `
                                    <div class="ab-security-layout__option-item ${q("#" + labelFor)?.checked ? "checked" : ""}" for="${labelFor}">
    ...
    function clickFunction() {
        ACTION_LIST = [
            ...
            {
                selector: ".ab-security-layout__tooltip-cta",
                event: "click",
