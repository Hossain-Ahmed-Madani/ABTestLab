console.log("====== PDP - Update Option Selector Styling [DTM] ========");
...
(() => {
    ...
    function mainJs() {
        ...
        poll(
            () => !!(document.querySelector(".nav-tabs .nav-link") && document.querySelector(".nav-tabs .nav-link").textContent.trim().toLowerCase().includes("stock")),
            () => {
