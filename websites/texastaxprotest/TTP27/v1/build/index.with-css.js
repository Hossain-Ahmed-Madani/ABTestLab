(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-TTP27 .ab-hidden {
  display: none;
}
.AB-TTP27 .ab-mobile {
  display: block;
...
(async () => {
    ...
    layout_info: [
      {
        ...
        selector:
          "figure:has(img[src='https://content.texastaxprotest.com/media/uploads/2025/12/Win-fair-tax-assessments-for-Texas-property-owners-1024x576.png'])",
  ...
  function updateLayout() {
    DATA["layout_info"].forEach(
      ({ title, selector, img_mobile_src, img_desktop_src }) => {
        ...
        const layout = /* HTML */ `
          <figure class="ab-figure-content wp-block-image size-large ab-mobile">
            <a
              href="https://www.texastaxprotest.com/blog-contact-us/"
              target="_blank"
          ...
          <figure
            class="ab-figure-content wp-block-image size-large ab-desktop"
          >
            <a
              href="https://www.texastaxprotest.com/blog-contact-us/"
              target="_blank"
  ...
  function handleScroll(e) {
    const isVisible = foundNodes.some((item) =>
