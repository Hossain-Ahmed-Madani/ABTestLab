...
(async () => {
    ...
    const ASSETS = {
        sign_in_svg: /* HTML */ `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const layout = /* HTML */ `
        <a href="https://client.texastaxprotest.com/login" target="_blank" class="ab-cta ab-sign-in-cta">
        ...
        <a href="${DATA[test_variation].link}" class="ab-cta ab-contact-cta">
            <span class="ab-cta__text ab-contact-cta__text"> ${DATA[test_variation].label}</span>
            <span class="ab-contact-cta__icon">→</span>
        </a>
    `;

    function updateLayout() {
        q("header .mantine-Group-root.mantine-visible-from-sm").insertAdjacentHTML("afterend", `<div class="ab-cta-container ab-cta-container--mobile">${layout}</div>`);
        q("header a.mantine-focus-auto[href='https://client.texastaxprotest.com/login']").insertAdjacentHTML(
            "afterend",
    ...
    function checkForItems() {
        return !!(
            ...
            q("header a.mantine-focus-auto[href='https://client.texastaxprotest.com/login']")
        );
    }
