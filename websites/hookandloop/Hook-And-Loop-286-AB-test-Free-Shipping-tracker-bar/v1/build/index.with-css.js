(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-FREE-SHIPPING-TRACKER-BAR
  .ab-show-free-shipping
  .ab-subtotal-progress-heading.ab-unlock-shipping,
.AB-FREE-SHIPPING-TRACKER-BAR
  .ab-show-free-shipping
...
.AB-FREE-SHIPPING-TRACKER-BAR
  .ab-show-free-shipping
  .ab-subtotal-progress-heading.ab-free-shipping {
  display: flex;
}
.AB-FREE-SHIPPING-TRACKER-BAR
  .ab-show-free-shipping
  .ab-subtotal-progress-bar__progress {
  background: #158a03;
}
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-container {
  padding-top: 15px;
  padding-bottom: 10px;
  display: flex;
...
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading {
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 4px;
}
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading.unlock-shipping {
  display: flex;
}
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading__icon {
  display: flex;
  align-items: center;
  justify-content: center;
  flex-shrink: 0;
}
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading__text {
  font-weight: 700;
  font-size: 14px;
  line-height: 20px;
  letter-spacing: 0px;
...
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading.ab-free-shipping {
  display: none;
}
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-heading__icon {
  display: flex;
...
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-bar {
  width: 100%;
  height: 8px;
  background: #e5e7eb;
  overflow: hidden;
...
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-bar__progress {
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
.AB-FREE-SHIPPING-TRACKER-BAR .ab-subtotal-progress-prices {
  display: flex;
  justify-content: center;
  align-items: center;
  font-weight: 700;
...
(async () => {
      ...
      <div class="ab-subtotal-progress-wrapper container hidden">
        <div class="ab-subtotal-progress-container">
          ...
          <div class="ab-subtotal-progress-bar">
            <div
              class="ab-subtotal-progress-bar__progress"
              style="width: 0%"
            ></div>
          </div>
          ...
          <div class="ab-subtotal-progress-prices">
            <span class="ab-added-subtotal"
              ><span class="ab-price">$0</span></span
            >
            <span>&nbsp;of&nbsp;</span>
            <span>$200</span>
          </div>
  ...
  function updateLayout() {
    ...
    const subtotalProgressContainer = q(
      "#cart-drawer .subtotal-progress-container",
    );
    const targetNode = q(".ab-subtotal-progress-wrapper");

    if (
      !subtotalProgressContainer ||
      (subtotalProgressContainer &&
        subtotalProgressContainer.parentNode.classList.contains("hidden"))
    ) {
    ...
    q(targetNode, ".ab-subtotal-progress-bar__progress").style.width =
  ...
  function checkForItems() {
    return !!(
      ...
      (q("#promotion-banner") || q(".breadcrumbs")) &&
      q("#cart-drawer")
    );
  }
