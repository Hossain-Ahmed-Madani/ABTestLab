(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-TEST015 .section.section--bg-orange:has(.teaser-oiv) ~ .section {
  display: none;
}
...
.AB-TEST015 .stage-landingpage__header:before {
  display: none;
}
.AB-TEST015 .stage-landingpage--no-disturber {
  background: none;
}
.AB-TEST015 .headline.headline--h1 {
...
.AB-TEST015 .headline.headline--h1 ~ p:empty {
  display: none;
}
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon {
  padding-left: 0;
  padding-bottom: 0;
  margin-bottom: 0;
}
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon li {
  display: flex;
...
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon > li:last-child {
  padding-bottom: 0;
}
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon li .ab-icon {
  display: block;
  width: 17px;
  min-width: 17px;
  height: 15px;
...
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon li .ab-icon svg {
  position: absolute;
  top: 3px;
  width: 17px;
  min-width: 17px;
...
.AB-TEST015 ul.list.list--unordered.list--unordered-with-icon li .ab-text {
...
.AB-TEST015 .ab-review-container {
  padding: 24px 0;
  padding-bottom: 12px;
  display: flex;
...
.AB-TEST015 .ab-review-top {
  display: flex;
  justify-content: flex-start;
  align-items: center;
  gap: 10px;
}
.AB-TEST015 .ab-review-stars svg {
  width: 120px;
  height: 20px;
}
...
.AB-TEST015 .stage-landingpage__picture {
  margin-left: -24px;
  margin-right: -24px;
  border-radius: 0;
}
...
.AB-TEST015 .stage-landingpage__picture-badge {
  box-shadow: none;
  display: flex;
  justify-content: flex-start;
  align-items: center;
...
.AB-TEST015 .stage-landingpage__picture-badge picture img {
  width: 100%;
  height: 80px;
  min-height: 80px;
  object-fit: contain;
}
.AB-TEST015 .ab-badge-text {
  font-family: "Inter", sans-serif;
  font-weight: 500;
  font-size: 16px;
  line-height: 150%;
...
.AB-TEST015 .ab-badge-text b {
  font-family: "Inter", sans-serif;
  font-weight: 700;
}
.AB-TEST015 .ab-new-heading-section-desktop {
  display: none;
}
.AB-TEST015 .ab-new-heading-section-mobile {
  background-color: #f6f5f3;
  padding: 24px;
}
...
.AB-TEST015 .stage-landingpage__header .stage-landingpage__picture-badge {
  display: none;
}
@media screen and (min-width: 991px) {
  .AB-TEST015 .ab-new-heading-section-mobile,
  .AB-TEST015 .stage-landingpage__picture .stage-landingpage__picture-badge {
    display: none;
  }
  .AB-TEST015 .stage-landingpage__picture {
    margin-left: 0;
  ...
  .AB-TEST015
    .stage-landingpage__header
    .stage-landingpage__picture-badge:after {
    display: none;
  }
  .AB-TEST015 .stage-landingpage__picture-badge picture img {
    height: 80px;
...
(async () => {
    ...
    star_reviews: /* HTML */ `
      ...
      >
        ...
        <g clip-path="url(#clip4_19059_81)">
          ...
          />
          <path
            d="M119.986 7.24316L114.992 12.1113L116.172 18.9844L113.344 17.498V6.27832L119.986 7.24316Z"
            fill="#D9D9D9"
          />
        </g>
        <defs>
  ...
  function updateLayout() {
    ...
    q("ul.list.list--unordered.list--unordered-with-icon").innerHTML =
      /* HTML */ `
        ${[
          ...
          .map(
            (txt) =>
              /* HTML */ `<li>
                <span class="ab-icon">${ASSETS.check_svg}</span>
    ...
    q("ul.list.list--unordered.list--unordered-with-icon").insertAdjacentHTML(
      ...
      /* HTML */ `
        <div class="ab-review-container">
          ...
          <div class="ab-review-bottom">
            Gesamtwertung ILS - fernstudiumcheck.de
          </div>
        </div>
      `,
    );
    ...
    q(".stage-landingpage__picture-badge").insertAdjacentHTML(
      "beforeend",
      /* HTML */ `<span class="ab-badge-text">
        Lehrgang <b>4 Wochen kostenlos</b> ausprobieren und dann durchstarten
      </span> `,
    );

    q(".stage-landingpage__header").insertAdjacentHTML(
      "beforeend",
      /* HTML */ ` ${q(".stage-landingpage__picture-badge").outerHTML} `,
    );

    q(
      ".section.section--pos-relative.section--spacing-top-none",
    ).insertAdjacentHTML(
      "afterend",
      /* HTML */ `
        <div class="ab-new-heading-section-mobile">
          <div class="ab-header">
            Erreichen Sie mit dem
  ...
  async function repositionElements() {
    const selector =
      ".section.section--spacing-bottom-none, .section:has(.teaser-course)";
