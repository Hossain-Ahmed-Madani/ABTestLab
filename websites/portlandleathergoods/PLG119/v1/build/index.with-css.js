(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-PLG119 #shoppinggives-accordion__cartdrawer ~ .mt-3.text-center.text-xs {
  display: none;
}
.AB-PLG119 .ab-usp-container {
  margin-top: 15px;
  margin-bottom: 1px;
  display: flex;
...
.AB-PLG119 .ab-usp-item {
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 4px;
}
.AB-PLG119 .ab-usp-item--reward {
  position: relative;
}
.AB-PLG119 .ab-usp-item__icon {
  width: 16px;
  height: 16px;
  display: flex;
  justify-content: center;
...
.AB-PLG119 .ab-usp-item__icon svg {
  width: 13px;
  height: auto;
}
.AB-PLG119 .ab-usp-item__title {
  font-family: Lato;
  font-weight: 400;
  font-style: Regular;
  font-size: 13.1px;
...
.AB-PLG119 .ab-usp-item__reward-info__icon {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 12px;
...
.AB-PLG119 .ab-usp-item__reward-info__popup--show {
  display: block;
}
.AB-PLG119 .ab-usp-item__reward-info__popup:after {
  content: "";
  right: 16px;
  bottom: -4.5px;
  position: absolute;
...
.AB-PLG119--v2 .ab-usp-item.ab-usp-item--return {
  display: none;
}
`;
...
(async () => {
  ...
  const ASSETS = {
    ...
    gift_box_svg: /* HTML */ `
      ...
      >
        ...
        />
        <path
          d="M6.5 6.49998V13.1666M0.5 3.83331H12.5V6.49998H0.5V3.83331Z"
          stroke="#2F323A"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
  ...
  function createLayout() {
    q(
      "#shoppinggives-accordion__cartdrawer ~ .mt-3.text-center.text-xs",
    ).insertAdjacentHTML(
      "afterend",
      /* HTML */ `
        <div class="ab-usp-container">
          ...
          <div class="ab-usp-item ab-usp-item--reward">
            ...
            <div class="ab-usp-item__title">
              Earn
              <span class="ab-usp-item__reward-points"
                >${getRewardPoints()}</span
              >
              Reward Pts
            </div>
            <div class="ab-usp-item__reward-info">
              <div class="ab-usp-item__reward-info__icon">
                ${ASSETS.reward_points_svg}
              </div>
    ...
    q("cart-container-drawer").addEventListener("click", (e) => {
      if (
        ...
        q(".ab-usp-item__reward-info__popup").classList.toggle(
          "ab-usp-item__reward-info__popup--show",
        );
        return;
      }
