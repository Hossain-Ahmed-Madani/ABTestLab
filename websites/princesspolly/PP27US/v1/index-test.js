(async () => {
    ...
    function injectStyles() {
        const cssText = /* HTML */ `.AB-PP27US .quick-shop-carousel-size, .AB-PP27US .quick-shop-size, .AB-PP27US .product-tile-size { display: none; } .AB-PP27US
        .ab-product-title:empty, .AB-PP27US .ab-product-price-container:empty, .AB-PP27US .ab-afterpay-container:empty, .AB-PP27US
        .ab-color-swatch-container:has(.product__swatches:empty)::after, .AB-PP27US .ab-color-swatch-container:has(.product__swatches:empty)::before, .AB-PP27US
        .ab-product-sizes-skeleton-loader__item { background-color: rgb(229, 229, 229); animation: pulse 0.5s infinite linear; border-radius: 2px; } .AB-PP27US .ab-product-title:empty {
        height: 20px; width: 60%; } .AB-PP27US .ab-product-price-container:empty { height: 21px; width: 30%; } .AB-PP27US .ab-afterpay-container:empty { height: 20px; width: 50%; }
        .AB-PP27US .ab-color-swatch-container:has(.product__swatches:empty) { display: flex; flex-wrap: wrap; } .AB-PP27US .ab-color-swatch-container:has(.product__swatches:empty)
        .product__active-color { order: -1; width: 100%; } .AB-PP27US .ab-color-swatch-container:has(.product__swatches:empty)::before { margin-right: 15px; } .AB-PP27US
        .ab-color-swatch-container:has(.product__swatches:empty)::after, .AB-PP27US .ab-color-swatch-container:has(.product__swatches:empty)::before { content: ""; display: block;
        height: 28px; width: 28px; border-radius: 50%; } .AB-PP27US .ab-product-size-selector-container:not(.ab-product-size-selector-container--initialized)
        .ab-product-sizes-skeleton-loader { display: grid; grid-template-columns: repeat(4, 1fr); gap: 5px; } .AB-PP27US
        .ab-product-size-selector-container:not(.ab-product-size-selector-container--initialized) .ab-product-sizes-skeleton-loader__item { display: block; height: 30px; } .AB-PP27US
        .ab-carousel-container { margin-bottom: 14px; margin-left: -13px; margin-right: -13px; } .AB-PP27US .ab-carousel-container .ab-swiper.swiper-initialized ~
        .ab-carousel-skeleton-loader { display: none; } .AB-PP27US .ab-carousel-container .ab-carousel-skeleton-loader { display: flex; justify-content: flex-start; align-items: center;
        gap: 5px; margin-bottom: 14px; overflow: hidden; } .AB-PP27US .ab-carousel-container .ab-carousel-skeleton-loader__item { width: 163px; min-width: 163px; height: 222px;
        background-color: rgb(229, 229, 229); animation: pulse 0.5s infinite linear; } .AB-PP27US .ab-carousel-container .ab-swiper:not(.swiper-initialized) { display: none; }
        .AB-PP27US .ab-carousel-container .ab-swiper .ab-swiper-slide { width: 163px !important; } .AB-PP27US .ab-carousel-container .ab-swiper-slide img { width: 163px; height: 222px;
        object-fit: cover; /* or contain, depending on your need */ } .AB-PP27US .ab-carousel-container .ab-swiper .swiper-pagination { display: flex; justify-content: center;
        align-items: center; gap: 8px; } .AB-PP27US .ab-carousel-container .ab-swiper .swiper-pagination-bullet { width: 6px !important; height: 6px !important; border: 1px solid
        rgb(255, 255, 255) !important; background-color: transparent !important; margin: 0 !important; } .AB-PP27US .ab-carousel-container .ab-swiper
        .swiper-pagination-bullet.swiper-pagination-bullet-active { border: 1px solid rgb(255, 255, 255) !important; background-color: rgb(255, 255, 255) !important; } .AB-PP27US
        .ab-product-title { font-family: "forma_djr_bannermedium", monospace, Helvetica, Arial, sans-serif; font-weight: 500; font-size: 16px; line-height: 20px; letter-spacing: 0.8px;
        vertical-align: middle; color: rgb(0, 0, 0); margin-bottom: 10px; } .AB-PP27US .ab-product-price-container { font-family: "forma_djr_bannermedium", monospace, Helvetica, Arial,
        sans-serif; font-weight: 500; font-size: 16px; line-height: 21px; letter-spacing: 0.8px; vertical-align: middle; color: rgb(0, 0, 0); margin-bottom: 14px; } .AB-PP27US
        .ab-product-price-container:has(span.product__price-savings-percent:not(:empty)) span[data-shop-currency], .AB-PP27US
