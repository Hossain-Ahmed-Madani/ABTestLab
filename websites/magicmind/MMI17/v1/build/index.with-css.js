...
.AB-MMI17 .ab-befits-bullet-item {
  display: flex;
...
.AB-MMI17 .ab-befits-bullet-item-icon {
  display: flex;
  justify-content: flex-start;
  align-items: center;
}
.AB-MMI17 .ab-befits-bullet-item-icon svg {
  width: 12px;
  min-width: 12px;
  height: 12px;
  min-height: 12px;
}
.AB-MMI17 .ab-befits-bullet-item-text {
  font-family: Circular, "sans-serif";
  font-weight: 450;
  font-size: 14px;
  line-height: 100%;
...
.AB-MMI17.AB-MMI17--v1 .ab-befits-bullets {
  display: none;
}
`;
...
(async () => {
  ...
  function checkForItems() {
    return !!(
      ...
      q(".main-product-v2__description p") &&
      q(".main-product-v2__open-modal-btn")
    );
  }
