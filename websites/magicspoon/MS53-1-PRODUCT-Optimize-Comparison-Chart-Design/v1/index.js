...
(function MS53_1_TEST() {
    ...
    const MS53_1_ASSETS = {
        ...
        checkCircleSvg: /* HTML */ `
            <svg class="check-circle-svg" width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        deleteCircleSvg: /* HTML */ `
            <svg class="delete-circle-svg" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_63_593)">
                    ...
                    <path
                        ...
                        stroke-linejoin="round"
                    />
                    <path d="M16.6595 8.3418L8.34253 16.6588" stroke="#3F0791" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M16.6595 16.6588L8.34253 8.3418" stroke="#3F0791" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
        ...
        return new Promise((resolve, reject) => {
            ...
            new MutationObserver((mutationList, observer) => {
                ...
                if (typeof predicate === "function" && predicate()) {
                    ...
                    reject(new Error(`Max polling count ${count} reached while waiting for predicate:\n${predicate.toString()}`));
                    observer.disconnect();
                }
        ...
        waitForElement(
            ...
            () => {
                ...
                targetNode.flickity({
                    ...
                    on: {
                        ready: function () {
                            targetNode.closest(".ab-nutrition-table-container").addClass("ab-flickity-added");
                        },
                    },
                });
            }
                ...
                <div class="ab-nutrition-table-container">
                    <div class="ab-nutrition-table">
                        <div class="ab-nutrition-table-column">
                            ...
                            ${rows.map((row) => /* HTML */ ` <div class="ab-nutrition-table-cell">${row}</div> `).join("")}
                        </div>
                        <div class="ab-nutrition-table-column ab-nutrition-table-column--magic-spoon">
                                ...
                                .map(
                                    (column) => /* HTML */ `
                                        <div class="ab-nutrition-table-column">
                                            ...
                                            ${rows.map((row) => /* HTML */ ` <div class="ab-nutrition-table-cell">${getCellContent(table_data[column][row])}</div> `).join("")}
                                        </div>
                                    `
                                )
                                .join("")}
