(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.MS53_1 #product-us-vs-them h2:not(.ab-sub-heading),
.MS53_1 #us-vs-them-banner {
  display: none;
}
.MS53_1 #product-us-vs-them .width.w-l > img {
  display: none;
}
.MS53_1 #product-us-vs-them,
.MS53_1 #product-us-vs-them.light-purp,
.MS53_1 .cereal-bars-template #product-us-vs-them {
  padding-top: 24px !important;
  padding-bottom: 58px !important;
}
.MS53_1 #product-us-vs-them .width.w-l {
  max-width: 100%;
  width: 100%;
}
.MS53_1 #product-us-vs-them .width.w-l:before {
  content: "";
...
.MS53_1 #product-us-vs-them h2.ab-sub-heading {
...
.MS53_1 #product-us-vs-them p {
  display: none;
}
.MS53_1 #product-us-vs-them .width.w-l:after {
...
.MS53_1 .ab-nutrition-table-container.ab-flickity-added {
  margin-bottom: 48px;
}
.MS53_1 .ab-nutrition-table-container {
  display: flex;
  justify-content: center;
  align-items: center;
  margin: auto;
...
.MS53_1 .ab-nutrition-table {
  display: flex;
  flex-wrap: nowrap;
  position: relative;
}
.MS53_1 .ab-nutrition-table > .ab-nutrition-table-column {
  width: 99px;
}
.MS53_1
  .ab-nutrition-table
...
.MS53_1 .ab-nutrition-table > .ab-nutrition-table-column--magic-spoon {
  width: 144px;
}
.MS53_1 .ab-nutrition-table-column-group.flickity-enabled .flickity-viewport {
  width: 100%;
}
.MS53_1 .ab-nutrition-table-column-group.flickity-enabled {
  position: static;
}
.MS53_1 .ab-nutrition-table-column-group .flickity-page-dots {
  left: 0;
  right: 0;
  bottom: -34px;
}
.MS53_1 .ab-nutrition-table-column-group .flickity-page-dots .dot {
  width: 15px;
  height: 15px;
...
.MS53_1 .ab-nutrition-table-cell:nth-child(2) {
...
.MS53_1 .ab-nutrition-table-cell {
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
...
.MS53_1 .ab-nutrition-table-cell:not(:first-child):not(:nth-child(2)) {
  height: 88px;
}
.MS53_1 .ab-nutrition-table-cell svg.check-circle-svg {
  width: 30px;
  height: 30px;
  object-fit: contain;
}
.MS53_1 .ab-nutrition-table-cell svg.delete-circle-svg {
  width: 21px;
  height: 21px;
  object-fit: contain;
}
...
.MS53_1 .ab-nutrition-table-column .ab-nutrition-table-cell:first-child {
  height: 110px;
  font-weight: 700;
  line-height: 20px;
  align-items: center;
}
.MS53_1 .ab-nutrition-table-column-group {
  display: flex;
  width: 99px;
}
.MS53_1 .ab-nutrition-table-column-group.flickity-enabled {
...
.MS53_1 .ab-nutrition-table-column-group > .ab-nutrition-table-column {
  min-width: 99px;
  max-width: 99px;
}
.MS53_1
...
.MS53_1 .ab-nutrition-table-column.ab-nutrition-table-column--magic-spoon {
...
.MS53_1 .ab-nutrition-table-cell--magic-spoon {
  min-height: max-content;
}
.MS53_1 .ab-nutrition-table-cell--magic-spoon svg {
  height: 48;
}
.MS53_1 .ab-nutrition-table-column--magic-spoon:after {
  content: "";
  height: 10px;
  display: block;
}
@media screen and (min-width: 1024px) {
  ...
  .MS53_1 .ab-nutrition-table > .ab-nutrition-table-column:nth-child(1) {
    min-width: 201px;
    max-width: 201px;
  }
  .MS53_1 .ab-nutrition-table > .ab-nutrition-table-column--magic-spoon {
  ...
  .MS53_1 .ab-nutrition-table-column-group:not(.flickity-enabled) {
    display: flex;
    width: 100%;
  }
  .MS53_1 .ab-nutrition-table-column-group.flickity-enabled {
