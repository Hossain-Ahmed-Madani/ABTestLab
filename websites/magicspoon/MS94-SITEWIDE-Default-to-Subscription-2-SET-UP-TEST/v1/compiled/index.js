    ...
    waitForElement(
        () =>
            !!(
                ...
                document.querySelectorAll(".ms24b-subscribe, .lsg-bundle-interval-el.lsg-bundle-interval-sub-el, .custom-rtx-subscription-label").length >= 1 &&
        ...
        () => {
            ...
            document.querySelectorAll(".ms24b-subscribe, .lsg-bundle-interval-el.lsg-bundle-interval-sub-el, .custom-rtx-subscription-label").forEach((item) => {
                item.click();
                window.scrollTo(0, 0);
            });
        }
