...
.AB-TEST013 .col-12.col-md-6 h1.h2.mb-3 ~ .tag-line.mb-4 {
  margin-top: 0 !important;
  margin-bottom: 21px !important;
}
...
.AB-TEST013 .col-12.col-md-6 h1.h2.mb-3 ~ .tag-line.mb-4 > .badge {
  font-family: "Onest Regular";
  font-weight: 400;
  font-size: 14.4px;
  line-height: 14.4px;
...
.AB-TEST013 .ab-course-info-box-btn-desktop-mobile ~ span:has(ul) {
  display: none;
}
...
.AB-TEST013 .ab-course-info-box-btn-desktop {
  display: none !important;
}
.AB-TEST013 #js-card-download .container-md:has(> hr) {
  display: none;
...
.AB-TEST013
  .registration-left
  .form-group:not(.form-input-group):not(.form-select-salutation):not(
    .form-field-land
  )
  .is-valid,
.AB-TEST013 .registration-left .form-field-street .is-valid,
...
.AB-TEST013 .registration-left em.is-invalid:not([style="display:none;"]) {
...
.AB-TEST013 .registration-left div:has(> input.is-invalid) {
  margin-bottom: 15px !important;
}
.AB-TEST013
  .registration-left
  div.form-field-house-number:has(> input.is-invalid) {
  margin-bottom: 45px !important;
}
.AB-TEST013
  .registration-left
  div.form-field-postal-code:has(> input.is-invalid),
.AB-TEST013 .registration-left div.form-field-city:has(> input.is-invalid) {
...
.AB-TEST013 #courseTabContent .h4.mb-2 {
  text-align: left;
  font-family: "Onest Bold";
  font-weight: 700;
  font-size: 24px;
...
@media screen and (min-width: 991px) {
  ...
  .AB-TEST013 .wf-course-badges-desktop + .container-md:has(> hr) {
    display: none;
  }
  .AB-TEST013 .ab-course-info-box-btn-desktop-mobile {
    display: none !important;
  ...
  .AB-TEST013 .ab-course-info-box-btn-desktop + .container-md:has(> hr) hr {
    margin-top: 41px;
    margin-bottom: 36px;
  }
  .AB-TEST013
...
(async () => {
  ...
  const ASSETS = {
    ...
    check_svg: /* HTML */ `<svg
      ...
      xmlns:xlink="http://www.w3.org/1999/xlink"
    >
      <rect width="20" height="20" fill="url(#pattern0_54_3225)" />
      <defs>
        <pattern
          id="pattern0_54_3225"
          patternContentUnits="objectBoundingBox"
          ...
          height="1"
        >
          <use xlink:href="#image0_54_3225" transform="scale(0.0078125)" />
        </pattern>
        <image
          id="image0_54_3225"
          width="128"
  ...
  function createAccordionNoTabLayout() {
    ...
    if (q("#courseTabContent") || !targetNode) return;
  ...
  function createAccordionWithTabLayout() {
    if (!q("#courseTabContent")) return;

    // const [targetNode1, targetNode2] = qq(".quick-info:not(:has(.mb-2:empty))");
    const [targetNode1, targetNode2] = qq(
      "#courseTabContent .col-12:has(.mb-2 > p)",
    );

    targetNode1.classList.add("ab-hidden");
    targetNode2.classList.add("ab-hidden");

    qq("#courseTabContent .col-md-6").forEach((item) => {
  ...
  function updateMainLayout() {
    ...
    const topBadgeContainer =
      ...
      q(".col-12.col-md-6 h1.h2.mb-3 ~ .tag-line.mb-4");

    if (infoList && topBadgeContainer) {
      topBadgeContainer.insertAdjacentHTML(
        "afterend",
        /* HTML */ `
          ...
          ${q(
            ...
            ? /* HTML */ `
                <div
                  class="ab-course-info-box-btn-desktop-mobile d-flex flex-column align-items-center"
                >
                  <a
                    href="#"
                    class="ab-course-info-box-btn-desktop-mobile-link btn btn-prio-1"
                    >Preise &amp; Probeinhalte anfordern 111</a
                  >
                </div>
              `
            : ""}
    ...
    q(
      ...
      /* HTML */ `
        ...
        <div
          class="ab-course-info-box-btn-desktop d-flex flex-column align-items-center"
        >
          <a
            href="#"
            class="ab-course-info-box-btn-desktop-mobile-link btn btn-prio-1"
            >Preise &amp; Probeinhalte anfordern</a
          >
        </div>
      `,
    );
    ...
    q("footer.page-footer").insertAdjacentElement(
      "beforebegin",
      q("div.frame-type-teaser_course_registration"),
    );
    qq(
