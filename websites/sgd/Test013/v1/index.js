...
(async () => {
    ...
    const ASSETS = {
        ...
        check_svg: /* HTML */ `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <rect width="20" height="20" fill="url(#pattern0_54_3225)" />
            <defs>
                <pattern id="pattern0_54_3225" patternContentUnits="objectBoundingBox" width="1" height="1">
    ...
    function createAccordionWithTabLayout() {
        ...
        const [targetNode1, targetNode2] = qq("#courseTabContent .col-12:has(.mb-2 > p)");
    ...
    function updateMainLayout() {
        ...
        const topBadgeContainer = q("div.my-3:has(> .badge.badge-.badge-type-action)") || q(".col-12.col-md-6 h1.h2.mb-3 ~ .tag-line.mb-4");
        ...
        q(".container-md.frame-space-before-medium.frame-space-after-medium")?.insertAdjacentHTML(
            "afterend",
            /* HTML */ `
                ...
                <div class="ab-course-info-box-btn-desktop d-flex flex-column align-items-center">
                    <a href="#" class="ab-course-info-box-btn-desktop-mobile-link btn btn-prio-1">Preise &amp; Probeinhalte anfordern</a>
                </div>
            `,
        );
            ...
            /* HTML */ `
                <div class="container-md ab-price-and-sample-btn-container">
                    <div class="d-flex flex-column align-items-center">
                        <a href="#" class="ab-price-and-sample-btn btn btn-prio-1">Preise & Probeinhalte einsehen</a>
                    </div>
                </div>
            `,
        );
        ...
        q("footer.page-footer").insertAdjacentElement("beforebegin", q("div.frame-type-teaser_course_registration"));
    ...
    function checkForItems() {
        return !!(
            ...
            (q("div.my-3:has(> .badge.badge-.badge-type-action)") || q(".col-12.col-md-6 h1.h2.mb-3 ~ .tag-line.mb-4")) &&
