(async () => {
    ...
    const ASSETS = {
        check_svg: /* HTML */ `
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <defs>
                    <pattern id="pattern0_2_361" patternContentUnits="objectBoundingBox" width="1" height="1">
    ...
    function init() {
        ...
        waitForElementAsync(
            ...
            referredCourseContainer.insertAdjacentHTML("afterbegin", `<p class="ab-preferred-course-subtitle">In welchem Bereich möchtest du beruflich voran kommen?</p>`);
