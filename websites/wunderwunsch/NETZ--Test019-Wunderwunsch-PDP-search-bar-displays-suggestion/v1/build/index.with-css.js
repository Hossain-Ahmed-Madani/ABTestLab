(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.TEST019-SEARCH-BAR.TEST019-SEARCH-BAR--show-suggestions-dropdown {
  overflow: hidden;
}
.TEST019-SEARCH-BAR.TEST019-SEARCH-BAR--show-suggestions-dropdown .header__logo,
.TEST019-SEARCH-BAR.TEST019-SEARCH-BAR--show-suggestions-dropdown
  .ab-toggle-search {
  opacity: 0;
}
.TEST019-SEARCH-BAR.TEST019-SEARCH-BAR--show-suggestions-dropdown
  .ab-search-bar-backdrop,
.TEST019-SEARCH-BAR.TEST019-SEARCH-BAR--show-suggestions-dropdown
...
.TEST019-SEARCH-BAR .ab-search-bar-backdrop {
  display: none;
  position: fixed;
  height: 100%;
  top: 0;
...
.TEST019-SEARCH-BAR .ab-search-bar-section {
  display: none;
  position: absolute;
  width: 100%;
...
.TEST019-SEARCH-BAR .ab-search-bar-container {
...
.TEST019-SEARCH-BAR .ab-search-bar {
  width: 100%;
  border: 1px solid #60062e;
  border-radius: 5px;
  display: flex;
  justify-content: center;
  align-items: center;
...
.TEST019-SEARCH-BAR .ab-search-bar__icon:hover,
.TEST019-SEARCH-BAR .ab-search-bar__icon:active {
  border: none;
  outline: none;
}
.TEST019-SEARCH-BAR .ab-search-bar__icon svg {
  width: 18px;
  height: 18px;
  object-fit: contain;
}
.TEST019-SEARCH-BAR .ab-suggestions-container {
  background: #fee7f1;
  display: flex;
  flex-direction: column;
}
.TEST019-SEARCH-BAR .ab-suggestions-content {
  padding: 10px 12px;
  display: flex;
  flex-direction: column;
  gap: 10px;
}
.TEST019-SEARCH-BAR .ab-suggestions-content__heading {
  height: 19px;
...
.TEST019-SEARCH-BAR .ab-suggestions-content__item:hover,
.TEST019-SEARCH-BAR .ab-suggestions-content__item:active {
  border: none;
  outline: none;
}
.TEST019-SEARCH-BAR .ab-suggestions-content__item__img {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 50px;
...
.TEST019-SEARCH-BAR .ab-suggestions-content__item__img img {
  width: 100%;
  height: 100%;
  object-fit: contain;
}
.TEST019-SEARCH-BAR .ab-suggestions-content__item__title {
  font-family: Nunito, sans-serif;
  font-weight: 500;
  font-size: 9px;
  line-height: 12px;
...
.TEST019-SEARCH-BAR .favorite-products .ab-suggestions-content__item {
  gap: 4px;
}
.TEST019-SEARCH-BAR .top-selection-of-categories {
  background-color: #ffffff;
}
.TEST019-SEARCH-BAR .top-selection-of-categories .ab-suggestions-content__item {
  gap: 5px;
}
.TEST019-SEARCH-BAR .popular-brands {
  padding: 10px 12px 11px;
}
.TEST019-SEARCH-BAR .popular-brands .ab-suggestions-content__item {
  gap: 5px;
}
.TEST019-SEARCH-BAR
  .popular-brands
  .ab-suggestions-content__item
  .ab-suggestions-content__item__img {
  border: none;
  width: 100%;
  height: 23px;
}
...
.TEST019-SEARCH-BAR .ab-searched-content {
  display: none;
  background: #fee7f1;
  padding: 10px 12px;
  max-height: 76vh;
...
.TEST019-SEARCH-BAR .header__icon-list a.header__icon-wrapper[href="/search"] {
  display: none;
}
.TEST019-SEARCH-BAR .ab-toggle-search {
  display: flex;
  justify-content: center;
  align-items: center;
}
.TEST019-SEARCH-BAR .ab-toggle-search svg {
  margin-bottom: -1px;
  height: 23px;
  width: 100%;
}
      ...
      suggestions: [
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/trixie-kinder-trinkflasche-personalisiert-tiere-wunderwunsch-788317.jpg?v=1744408486&width=400",
        },
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/stapelwelt-abenteuerbrucke-fur-stapelstein-wunderwunsch-897355.jpg?v=1744406824&width=500",
        },
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/trixie-grosser-kindergartenrucksack-personalisiert-tiere-wunderwunsch-261264.jpg?v=1744408445&width=700",
        },
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/trixie-grosser-kindergartenrucksack-personalisiert-tiere-wunderwunsch-261264.jpg?v=1744408445&width=500",
        },
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/products/erinnerungsbox-holz-mit-wunschdaten-tier-aquarell-wunderwunsch-945447.png?v=1758005472&width=500",
        },
      ],
    },
    {
      ...
      suggestions: [
        ...
        },
        {
          ...
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/led-nachtlicht-kinder-personalisiert-tiere-blumenkreis-rosa-aquarell-wunderwunsch-422474.jpg?v=1744407817&width=500",
        },
        {
          title: "Geburt und Taufe",
          link: "https://www.wunderwunsch.de/collections/geburt-taufe",
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/products/babyrassel-personalisiert-giraffe-fuchs-lowe-nilpferd-wunderwunsch-391848.webp?v=1744793585&width=500",
        },
        {
          title: "Stapelwelt",
          link: "https://www.wunderwunsch.de/collections/stapelwelt",
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/stapelwelt-abenteuer-racer-wunderwunsch-221434.jpg?v=1744406033&width=500",
        },
        {
          title: "Bundles",
          link: "https://www.wunderwunsch.de/collections/geschenksets-spar-bundles",
          imgUrl:
            "https://www.wunderwunsch.de/cdn/shop/files/starter-geschenkset-lowe-personalisiert-rucksack-lunchbox-flasche-stift-wunderwunsch-1068025.jpg?v=1755638202&width=500",
        },
      ],
    },
    {
      ...
      suggestions: [
        {
          ...
          link: "https://www.wunderwunsch.de/collections/stapelwelt",
          imgUrl:
            "https://cdn-3.convertexperiments.com/uf/1004828/10041371/edbf298b692393f68659729a4a6f183c3984e396_69008aa5ee877.png",
        },
        {
          title: "Jollein",
          link: "https://www.wunderwunsch.de/collections/jollein",
          imgUrl:
            "https://cdn-3.convertexperiments.com/uf/1004828/10041371/e116212c2bc82cab7b18ca2dc229ed1906e07a7e_69008aa66d1d4.png",
        },
        {
          title: "Trixie",
          link: "https://www.wunderwunsch.de/collections/trixie",
          imgUrl:
            "https://cdn-3.convertexperiments.com/uf/1004828/10041371/a04b41b9830f66329334347f5035fc39bdd58ca9_69008aa6663f4.png",
        },
        {
          title: "Small Foot",
          link: "https://www.wunderwunsch.de/collections/small-foot",
          imgUrl:
            "https://cdn-3.convertexperiments.com/uf/1004828/10041371/9c3470a5bbd2e767d79792068affbe1ba11efaf0_69008aa660d42.png",
        },
        {
          title: "Lässig",
          link: "https://www.wunderwunsch.de/collections/lassig",
          imgUrl:
            "https://cdn-3.convertexperiments.com/uf/1004828/10041371/ef01e3f8f04196d85f7f9bb43fbbab5422933714_69008aa693284.png",
        },
      ],
    },
  ];
      ...
      <div class="ab-search-bar-container">
        <div class="ab-search-bar">
          <input
            ...
            placeholder="Finde jetzt dein Lieblingsprodukt"
          />
          <button type="button" class="ab-search-bar__icon">
            ${ASSETS.search_icon_svg}
          </button>
        </div>
      </div>
                  ...
                  .map(
                    ({ title, link, imgUrl }) => /* HTML */ `
                      <a href="${link}" class="ab-suggestions-content__item">
                        ...
                        <div class="ab-suggestions-content__item__title">
                          ${title}
                        </div>
                      </a>
                    `,
