(async () => {
    ...
    function initCarousel() {
        const $carousels = window.jQuery(".ab-promotion-banner-container.owl-carousel");
    ...
    function checkForItems() {
        return !!(q(`body:not(.${page_initials})`) && q(".review-template") && q(".review-template-navbar") && q(".free-delivery-btn-header"));
    }
