...
@media (min-width: 991px) {
    ...
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters:not(.snize-hidden)) .snize-horizontal-left {
        width: 232px;
        min-width: 232px;
        height: 100%;
        padding-right: 5px;
    ...
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters:not(.snize-hidden)) .snize-header {
        width: 100%;
    }
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters:not(.snize-hidden)) .snize-search-results-header {
        max-width: 100%;
        height: auto;
        display: flex;
    ...
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters:not(.snize-hidden)) .snize-horizontal-right {
        min-width: 200px;
        margin-left: 15px;
        display: flex;
        order: 3;
    }
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters:not(.snize-hidden)) .ab--filter-chips {
        padding-top: 0;
    }
    .AB-FILTER-CHIPS.snize-results-page:has(.snize-product-filters.snize-hidden) .ab--filter-chips-wrap {
        display: none;
    }
}
