(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-LME95 .ab-inline-ad {
  grid-column: span 2;
...
.AB-LME95 .ab-inline-ad:hover,
.AB-LME95 .ab-inline-ad:focus {
  border: none;
  outline: none;
}
.AB-LME95 .ab-inline-ad__container {
  width: 100%;
  height: 100%;
  display: flex;
...
.AB-LME95 .ab-inline-ad__container > img {
  width: 100%;
  height: auto;
}
.AB-LME95 img.ab-inline-ad__img--mobile {
  display: block;
}
.AB-LME95 img.ab-inline-ad__img--desktop {
  display: none;
}
@media screen and (min-width: 750px) {
  .AB-LME95 .ab-inline-ad {
    grid-column: span 1;
  }
  .AB-LME95 img.ab-inline-ad__img--mobile {
    display: none;
...
(async () => {
  ...
  const ASSETS = {
    img_url_mobile:
      "https://cdn.shopify.com/s/files/1/0654/8042/5686/files/muscle_toning_gummies_mobile.png?v=1764866569",
    img_url_desktop:
      "https://cdn.shopify.com/s/files/1/0654/8042/5686/files/muscle_toning_gummies_desktop.png?v=1764866569",
  };
  ...
  const DATA = {
    sibling_selector: {
      ...
      2: {
        ...
        "(min-width: 750px) and (max-width: 1199px)":
          ".collection__items > *:nth-child(5)",
  ...
  function getTargetSelector() {
    const mediaQuery = Object.keys(
      DATA["sibling_selector"][test_variation],
    ).find((mq) => window.matchMedia(mq).matches);
  ...
  function createLayout() {
      ...
      /* HTML */ `
        <a class="ab-inline-ad" href="#" rel="noopener noreferrer">
          <div class="ab-inline-ad__container">
            <img
              class="ab-inline-ad__img--mobile"
              src="${ASSETS["img_url_mobile"]}"
              alt="${page_initials}--image"
            />
            <img
              class="ab-inline-ad__img--desktop"
              src="${ASSETS["img_url_desktop"]}"
              alt="${page_initials}--image"
            />
          </div>
        </a>
    ...
    q(".ab-inline-ad").addEventListener("click", (e) => {
      ...
      fireGA4Event(
        `LME95_InLineAdClick`,
        `Variation ${test_variation},  user clicks on the in-line ad card`,
      );
      setTimeout(() => {
        const redirectUrl =
          "https://lemmelive.com/products/lemme-greens-gummies";
