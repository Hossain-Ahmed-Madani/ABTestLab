(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `@media screen and (min-width: 991px) {
  .AB-GP90 .products:not(.owl-carousel) .wcpb-product-badges-loop-container {
...
(async () => {
  ...
  function updateLayoutV2() {
    ...
    let targetNode =
      q(".products:not(.owl-carousel) > li:nth-child(10)") ||
      q(".products:not(.owl-carousel) > li:last-child");
    targetNode.insertAdjacentHTML("afterend", layout);
  }
  ...
  function clickFunction() {
    q(".products:not(.owl-carousel)").addEventListener("click", (e) => {
      if (e.target.closest(".category-ads-shortcode a")) {
        ...
        const href = e.target
          .closest(".category-ads-shortcode a")
          .getAttribute("href");

        if (
          href === "https://guideposts.org/shop/product/guideposts-magazine/"
        ) {
