(function () {
    ...
    const ASSETS = {
        purified_svg: /* HTML */ `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        spring_svg: /* HTML */ `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        alkaline_svg: /* HTML */ `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        distilled_svg: /* HTML */ `<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    function injectStyles() {
        ...
        style.type = "text/css";
        style.textContent = `
        .AB-PMO23 [data-modal-v2-trigger].modal-v2__trigger__ready,
        ...
        .AB-PMO23 .ab-storyblok-modal > .wrapper-outer > .wrapper-inner button.wrapper-btn-close,
        .AB-PMO23 .ab-storyblok-modal > .wrapper-outer > .wrapper-inner button.wrapper-btn-close:hover,
        .AB-PMO23 .ab-storyblok-modal > .wrapper-outer > .wrapper-inner button.wrapper-btn-close:focus {
            border: none;
            outline: none;
        }
        ...
        .AB-PMO23 .ab-storyblok-modal > .wrapper-outer > .wrapper-inner > .wrapper-body {
            gap: 0;
        }
        .AB-PMO23 .storyblok-modal > .wrapper-outer > .wrapper-inner > .wrapper-body {
            overflow: visible;
        }
        .AB-PMO23 .ab-storyblok-modal .storyblok-text-blocks .wrapper-frames .wrapper-frame:nth-child(3):last-child {
            grid-column: span 1;
        }
        Z .AB-PMO23 .ab-wrapper-body .wrapper-heading {
        ...
        @media screen and (max-width: 767.5px) {
            ...
            .AB-PMO23 .modal-v2.pop-up.ab-storyblok-modal > .wrapper-outer > .wrapper-inner {
                margin: 1.5rem 1rem;
            }
        ...
        @media screen and (min-width: 959px) {
            .AB-PMO23--v2 .ab-storyblok-modal .wrapper-inner.h-full.flex.lg\:flex-col.self-center {
        ...
        * ----------------------------------------
        */
        body.AB-PMO23--modal-show {
            overflow: hidden;
        }
        body.AB-PMO23--modal-show .AB-PMO23__modal-layout {
            display: flex;
        }
        body.AB-PMO23--modal-show .AB-PMO23__modal-backdrop {
            display: block;
        }
        ...
        .AB-PMO23__modal__head__close-cta {
            margin: 0;
            padding: 0;
            position: absolute;
            top: 15px;
        ...
        .AB-PMO23__modal__head__close-cta svg {
            width: 10px;
            height: 10px;
        }
        ...
        .AB-PMO23__modal__body .table.table-bordered tr td {
            background: none;
        }
        ...
        .scale-in {
            -webkit-animation: scale-in 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
            animation: scale-in 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
        }

        .scale-out {
            -webkit-animation: scale-out 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
            animation: scale-out 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
        }
    ...
    function createModalLayout() {
        if (document.querySelector(`.${page_initials}__modal-open-cta`)) return;
        ...
        const layout = /* HTML */ `
            <div class="${page_initials}__modal-layout ab-wrapper-body">
                ...
                <div class="${page_initials}__modal">
                    ...
                    <div
                        class="${page_initials}__modal__body  ab-storyblok-modal ${"ab-wrapper-body--quantity-active"
                            }"
                    >
    ...
    function hasAllTargetElements() {
        return !!(
            document.querySelector('meta[property="og:url"][content*="start-water-delivery"]') &&
    ...
    function handleLocationChanges() {
        ...
        document.querySelectorAll(`.${page_initials}__modal-layout, .${page_initials}__modal-open-cta, #${page_initials}-styles`)?.forEach((item) => item.remove());
        window[page_initials] = false;


        if (document.querySelector('meta[property="og:url"][content*="start-water-delivery"]')) {
            waitForElement(hasAllTargetElements, init);
        }
    }

    function urlObserver() {
        const debouncedChanges = debounce(handleLocationChanges, 1500);
