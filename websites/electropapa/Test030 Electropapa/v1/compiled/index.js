(async () => {
    ...
    const ASSETS = {
        exclamation_svg: /* HTML */ `
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <defs>
                    <pattern id="pattern0_6392_3644" patternContentUnits="objectBoundingBox" width="1" height="1">
    ...
    function init() {
        ...
        targetNode.insertAdjacentHTML(
            "afterbegin",
            /* HTML */ `
                <div class="ab-up-selling-title">Mit mehr Kapazität (mAh) die Akkulaufzeit deutlich verlängern</div>
                <div class="ab-up-selling-subtitle">
                    <span  class="ab-up-selling-subtitle__icon">${ASSETS.exclamation_svg}</span>
                    <span class="ab-up-selling-subtitle__title">Alle Kapazitäten sind mit deinem Gerät kompatibel</span>
                </div>
            `,
        );
    }
