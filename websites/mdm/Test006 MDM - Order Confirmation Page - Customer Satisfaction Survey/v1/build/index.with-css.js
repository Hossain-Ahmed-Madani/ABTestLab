(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.AB-TEST006 .az-textblock.az-success-upgrade__text-block {
  display: flex;
  gap: 25px;
}
.AB-TEST006 .ab-survey-container {
  margin-left: auto;
...
.AB-TEST006 .ab-survey-top {
  display: flex;
  justify-content: flex-start;
  align-items: center;
  gap: 14px;
}
.AB-TEST006 .ab-survey-icon {
  width: 46px;
  min-width: 46px;
  height: 46px;
  min-height: 46px;
...
.AB-TEST006 .ab-survey-icon svg {
  width: 22px;
  height: 22px;
}
.AB-TEST006 .ab-survey-text-block {
  display: flex;
  flex-direction: column;
  gap: 4px;
}
.AB-TEST006 .ab-survey-title {
...
.AB-TEST006 .ab-survey-bottom {
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 10px;
}
.AB-TEST006 .ab-survey-cta {
  display: flex;
  justify-content: center;
  align-items: center;
  width: 140px;
...
.AB-TEST006 .ab-survey-cta:hover {
  text-decoration: none;
}
.AB-TEST006 .ab-survey-pill-block {
  display: flex;
  justify-content: flex-start;
  align-items: center;
  gap: 6px;
}
.AB-TEST006 .ab-survey-pill-item {
...
.AB-TEST006 .ab-survey-pill-icon {
  display: flex;
  justify-content: center;
  align-items: center;
}
.AB-TEST006 .ab-survey-pill-icon svg {
  width: 13px;
  height: 13px;
}
.AB-TEST006 .ab-survey-pill-text {
  font-family: "Inter", sans-serif;
  font-weight: 400;
  font-size: 11px;
  line-height: 100%;
