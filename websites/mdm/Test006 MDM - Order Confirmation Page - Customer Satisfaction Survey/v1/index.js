(async () => {
    const TEST_CONFIG = {
        ...
        test_name: "Test006 [MDM] - Order Confirmation Page - Customer Satisfaction Survey",
    ...
    const ASSETS = {
        note_svg: /* HTML */ `<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
            ...
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="M8.25 11H13.75M8.25 14.6667H11.9167" stroke="white" stroke-width="1.65" stroke-linecap="round" stroke-linejoin="round" />
        </svg> `,
        clock_svg: /* HTML */ `<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_822_101)">
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M6.5 3.25V6.5L8.66667 7.58333" stroke="#B5963A" stroke-width="1.08333" stroke-linecap="round" stroke-linejoin="round" />
            </g>
            <defs>
        ...
        lock_svg: /* HTML */ `<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        coupon_svg: /* HTML */ `<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="M7.04175 2.70837V3.79171M7.04175 9.20837V10.2917M7.04175 5.95837V7.04171" stroke="#B5963A" stroke-width="1.08333" stroke-linecap="round" stroke-linejoin="round" />
        </svg> `,
    };
    ...
    function getLayout() {
        ...
        return /* HTML */ `
            <div class="ab-survey-container">
                <div class="ab-survey-top">
                    <div class="ab-survey-icon">${ASSETS.note_svg}</div>
                    <div class="ab-survey-text-block">
                        <div class="ab-survey-title">Beantworten Sie 6 kurze Fragen & sparen Sie 10€ beim nächsten Einkauf.</div>
                        <div class="ab-survey-subtitle">Ihre Meinung hilft uns, unseren Shop und Service weiter zu verbessern.</div>
                    </div>
                </div>
                <div class="ab-survey-bottom">
                    ...
                    <a target="_blank" href="${window.location.href.includes("dop") ? "https://forms.gle/cq9ymK9i3a4UgUQSA" : "https://forms.gle/ZkxfqRt4ztBDnShN7"}" class="ab-survey-cta">Jetzt teilnehmen</a>
                </div>
            </div>
        `;
    }
    ...
    function checkForItems() {
        return !!(
            ...
            (window.innerWidth < 1024 ? q(".az-countdown__banner") : q(".az-textblock.az-success-upgrade__text-block"))
        );
    }
    ...
    async function init() {
        try {
            ...
            const targetNode = isMobile ? q(".az-countdown__banner") : q(".az-textblock.az-success-upgrade__text-block");
            ...
            if (isMobile) {
                ...
                qq(".az-textblock.az-success-upgrade__text-block > *").forEach((element) => {
                    div.appendChild(element);
                });

                targetNode.insertAdjacentElement("afterbegin", div);
                targetNode.insertAdjacentHTML("beforeend", getLayout());
            }
        } catch (error) {
            return false;
        }
